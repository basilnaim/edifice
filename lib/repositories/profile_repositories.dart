...
class ProfileRepository {
  Future<ProfileCountersResponse> getProfileCountersResponse() async {
    ...
    print("${AppConfig.BASE_URL}/profile/counters/${user_id.value}");
  ...
  Future<ProfileUpdateResponse> getProfileUpdateResponse(
    ...
    final response = await http.post("${AppConfig.BASE_URL}/profile/update",
        ...
        body: post_body);
    print("${AppConfig.BASE_URL}/profile/update");
  ...
  Future<DeviceTokenUpdateResponse> getDeviceTokenUpdateResponse(
    ...
    final response =
        await http.post("${AppConfig.BASE_URL}/profile/update-device-token",
            ...
            body: post_body);
    print("${AppConfig.BASE_URL}/profile/update-device-token");
    print(response.body.toString());
  ...
  Future<ProfileImageUpdateResponse> getProfileImageUpdateResponse(
    ...
    final response =
        await http.post("${AppConfig.BASE_URL}/profile/update-image",
            ...
            body: post_body);
    print("${AppConfig.BASE_URL}/profile/update-image");
    //print(response.body.toString());
