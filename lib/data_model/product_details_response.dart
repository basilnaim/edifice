...
class DetailedProduct {
  ...
  String link;
  int digital;
  String stock_visibility_state;
  int allow_overselling;
  String tax_msg;
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) => DetailedProduct(
    ...
    sttributesform: List<AttrForm>.from(json["sttributesform"].map((x) => AttrForm.fromJson(x))),//List<AttrForm>.from(json["sttributesform"].map((x) => AttrForm.fromJson(x))),
    ...
    allow_overselling: json["allow_overselling"],
    tax_msg: json["tax_msg"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "sttributesform": List<dynamic>.from(sttributesform.map((x) => x.toJson())),
...
class AttrForm {
  ...
  factory AttrForm.fromJson(Map<String, dynamic> json) => AttrForm(
    id: json["id"].toString(),
    title: json["title"],
    attributelist:List<Attributelist>.from(json["attributelist"].map((x) => Attributelist.fromJson(x))),//Attributelist.fromJson(json["attributelist"]),
  );
