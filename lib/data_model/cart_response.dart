...
class CartResponse {
  CartResponse({
    ...
    this.owner_id,
    this.cart_items,
    this.cart_items_digital
  });

  String name;
  int owner_id;
  List<CartItem> cart_items;
  List<CartItemsDigital> cart_items_digital;
  ...
  factory CartResponse.fromJson(Map<String, dynamic> json) => CartResponse(
    ...
    cart_items_digital: json["cart_items_digital"] == null ? null : List<CartItemsDigital>.from(json["cart_items_digital"].map((x) => CartItemsDigital.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "cart_items_digital": cart_items_digital == null ? null : List<dynamic>.from(cart_items_digital.map((x) => x.toJson())),
  };
}
...
class CartItemsDigital {
  ...
  factory CartItemsDigital.fromJson(Map<String, dynamic> json) => CartItemsDigital(
    id: json["id"] == null ? null : json["id"],
    owner_id: json["owner_id"] == null ? null : json["owner_id"],
    user_id: json["user_id"] == null ? null : json["user_id"],
    product_id: json["product_id"] == null ? null : json["product_id"],
