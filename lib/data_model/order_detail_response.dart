...
String shipnull="{name:"",email:"",address:"",country:"",city:"",postal_code:"",phone:""}";
...
class DetailedOrder {
  ...
  factory DetailedOrder.fromJson(Map<String, dynamic> json) => DetailedOrder(
    ...
    shipping_address: json["shipping_address"].toString()=='[]'?(json[shipnull]):ShippingAddress.fromJson(json["shipping_address"]),
