...
class MyTheme{
  ...
  static Color accent_colorw = Color.fromRGBO(230, 241, 255, 1.0);
  static Color accent_color = Color.fromRGBO(13, 64, 118, 1.0);
 // static Color soft_accent_color = Color.fromRGBO(247,189,168, 1);
  static Color soft_accent_color = Color.fromRGBO(184, 37, 222, 1.0);
  static Color softsoft_accent_color = Color.fromRGBO(209, 191, 215, 1.0);
//  statcic Color splash_screen_color = Color.fromRGBO(230,46,4, 1); // if not sure , use the same color as accent color
  static Color splash_screen_color = Color.fromRGBO(118, 35, 141, 1);
  ...
  static Color golden = Color.fromRGBO(245, 147, 30, 1.0);
