...
import '../screens/password_otp.dart';
            ...
            child: SingleChildScrollView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    AppTranslation.translationsKeys[langu_choos.value]['Forget Password ?'],
                    style: TextStyle(
                          ...
                          child: FlatButton(
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius: const BorderRadius.all(
                                    Radius.circular(12.0))),
                            child: Text(
                              AppTranslation.translationsKeys[langu_choos.value]['Send Code'],
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600),
