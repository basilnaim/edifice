...
class WhichFilter {
  ...
  static List<WhichFilter> getWhichFilterList() {
    return <WhichFilter>[
      WhichFilter('product', AppTranslation.translationsKeys[langu_choos.value]['Products']),
      WhichFilter('sellers', AppTranslation.translationsKeys[langu_choos.value]['Sellers']),
      WhichFilter('brands',  AppTranslation.translationsKeys[langu_choos.value]['Brands']),
    ];
  }
}
        ...
        Container(
          ...
          child: Center(
            child: new DropdownButton<WhichFilter>(
              ...
              hint: Text(
                AppTranslation.translationsKeys[langu_choos.value]['Products'],
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 13,
                ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 2),
                      Text(
                        AppTranslation.translationsKeys[langu_choos.value]['Filter'],
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 13,
                        ),
        ...
        GestureDetector(
          onTap: () {
            _selectedFilter.option_key == "product"
                ...
                : ToastComponent.showDialog(
                AppTranslation.translationsKeys[langu_choos.value]['You can use sorting while searching for products'],
                context,
                gravity: Toast.CENTER,
                duration: Toast.LENGTH_LONG);
          },
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 2),
                      Text(
                        AppTranslation.translationsKeys[langu_choos.value]['Sort'],
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 13,
                        ),
    ...
    return Column(
      ...
      children: [
        Padding(
            ...
            child: Text(
              AppTranslation.translationsKeys[langu_choos.value]['Sort Products By'],
            )),
        RadioListTile(
          dense: true,
          value: "",
          ...
          title: Text(AppTranslation.translationsKeys[langu_choos.value]['Default']),
          onChanged: (value) {
            setState(() {
              _selectedSort = value;
            });
        ...
        RadioListTile(
          ...
          controlAffinity:
          ListTileControlAffinity.leading,
          title: Text(AppTranslation.translationsKeys[langu_choos.value]['Price high to low']),
          onChanged: (value) {
        ...
        RadioListTile(
          ...
          controlAffinity:
          ListTileControlAffinity.leading,
          title: Text(AppTranslation.translationsKeys[langu_choos.value]['Price low to high']),
          onChanged: (value) {
            setState(() {
              _selectedSort = value;
            });
        ...
        RadioListTile(
          ...
          controlAffinity:
          ListTileControlAffinity.leading,
          title: Text(AppTranslation.translationsKeys[langu_choos.value]['New Arrival']),
          onChanged: (value) {
            setState(() {
              _selectedSort = value;
            });
        ...
        RadioListTile(
          ...
          controlAffinity:
          ListTileControlAffinity.leading,
          title:  Text(AppTranslation.translationsKeys[langu_choos.value]['Popularity']),
          onChanged: (value) {
            setState(() {
              _selectedSort = value;
            });
        ...
        RadioListTile(
          ...
          controlAffinity:
          ListTileControlAffinity.leading,
          title: Text(AppTranslation.translationsKeys[langu_choos.value]['Top Rated']),
          onChanged: (value) {
            setState(() {
              _selectedSort = value;
            });
          ...
          child: Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    hintText: AppTranslation.translationsKeys[langu_choos.value]['Search here ?'],
                    hintStyle: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        AppTranslation.translationsKeys[langu_choos.value]['Price Range'],
                        style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  hintText: AppTranslation.translationsKeys[langu_choos.value]['Minimum'],
                                  hintStyle: TextStyle(
                                      fontSize: 12.0,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              inputFormatters: [_amountValidator],
                              decoration: InputDecoration(
                                  hintText:AppTranslation.translationsKeys[langu_choos.value]['Maximum'],
                                  hintStyle: TextStyle(
                                      fontSize: 12.0,
                                      color: MyTheme.textfield_grey),
                                  enabledBorder: OutlineInputBorder(
                ...
                SliverList(
                  delegate: SliverChildListDelegate([
                    Padding(
                      padding: const EdgeInsets.only(left: 16.0),
                      child: Text(
                        AppTranslation.translationsKeys[langu_choos.value]['categories'],
                        style: TextStyle(
                            fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                    ),
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCard(
                      ...
                      earn_point: _productList[index].earn_point,
                      discount:_productList[index].discount,
                      custom_text: _productList[index].custom_text ?? "",
                      tax_msg: _productList[index].tax_msg ?? "",);
                },
              )
            ],
          ),
