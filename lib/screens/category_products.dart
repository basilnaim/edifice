      ...
      title: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                hintText: AppTranslation.translationsKeys[langu_choos.value]['Search products from']+" : " + widget.category_name,
                hintStyle:
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ProductCard(
                  ...
                  has_discount: _productList[index].has_discount??false,
                  withrating: true,
