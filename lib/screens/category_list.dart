...
class _CategoryListState extends State<CategoryList> {
  ...
  String getAppBarTitle() {
    String name = widget.parent_category_name == ""
        ...
        ? AppTranslation.translationsKeys[langu_choos.value]['top categories']
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      ...
                      child: Text(
                        AppTranslation.translationsKeys[langu_choos.value]['view sub-categories'],
                        textAlign: TextAlign.left,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: TextStyle(
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        AppTranslation.translationsKeys[langu_choos.value]['view products'],
                        textAlign: TextAlign.left,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: TextStyle(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  child: Text(
                    AppTranslation.translationsKeys[langu_choos.value]['All Products of '] + widget.parent_category_name,
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
