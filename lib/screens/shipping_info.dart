...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  onPressProceed(context) async{
    print(_seleted_shipping_address);
    ...
    print("ggg"+widget.owner_id.toString());
            ...
            slivers: [
              SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    Container(height:40,child: Center(child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) {
                          return Address();
                        })).then((value) {
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          AppTranslation.translationsKeys[langu_choos.value]['Go to address page'],
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        AppTranslation.translationsKeys[langu_choos.value]['SHIPPING COST']+"${_shipping_cost_string}",
        ...
        child: Row(
          ...
          children: [
            FlatButton(
              ...
              child: Text(
                AppTranslation.translationsKeys[langu_choos.value]['PROCEED TO CHECKOUT'],
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                    fontWeight: FontWeight.w600),
