...
class _SellerDetailsState extends State<SellerDetails> {
              ...
              SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Padding(
                    ...
                    child: Text(
                      AppTranslation.translationsKeys[langu_choos.value]['New Arrivals'],
                      style: TextStyle(
              ...
              SliverList(
                delegate: SliverChildListDelegate([
                  Padding(
                    ...
                    child: Text(
                      AppTranslation.translationsKeys[langu_choos.value]['Top Selling Products'],
                      style: TextStyle(
                          color: MyTheme.font_grey,
                          fontSize: 16,
                          fontWeight: FontWeight.w600),
                  ...
                  Padding(
                    ...
                    child: Text(
                      AppTranslation.translationsKeys[langu_choos.value]['featured products'],
                      style: TextStyle(
                          color: MyTheme.font_grey,
                          fontSize: 16,
                          fontWeight: FontWeight.w600),
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ProductCard(
              ...
              earn_point: _featuredProducts[index].earn_point,
              discount:_featuredProducts[index].discount,
              custom_text: _featuredProducts[index].custom_text ?? "",
              tax_msg: _featuredProducts[index].tax_msg ?? "",);
        },
      );
    } else {
      return Container(
  ...
  buildShowProductsButton(BuildContext context) {
    return FlatButton(
      ...
      child: Text(
        AppTranslation.translationsKeys[langu_choos.value]['View All Products From This Seller'],
        style: TextStyle(
