...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  List<TextEditingController> _attformController = [];
  ...
  fetchProductDetails() async {
    ...
    if (productDetailsResponse.detailed_products.length > 0) {
      ...
      if (productDetailsResponse.detailed_products[0].digital == 1) {
        isdigit = true;
        print("isdigit");
      } else {
        isdigit = false;
  ...
  setProductDetailValues() {
    if (_productDetails != null) {
      ...
      _taxmsg = _productDetails.tax_msg.toString();
      calculateTotalPrice();
      ...
      _productDetails.sttributesform.forEach((sttributesform) {
        _selectedattform.add(sttributesform.attributelist[0]);
      });
  ...
  fetchAndSetVariantWiseInfo({bool change_appbar_string = true}) async {
    ...
    if (change_appbar_string) {
      _appbarPriceString =
          "${variantResponse.variant} ${_singlePriceString}" + "${_taxmsg}";
    }
  ...
  setattformString(i) {
    _attformString = _attformController[i]
        .text
        .toString(); //_selectedattform.join(",").toString();
    setState(() {});
  }

  _onVariantChangeattform(_att_form_index, value) {
    _selectedattform[_att_form_index] = value;
    setattformString(_att_form_index);
    setState(() {});
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Text(
                    AppTranslation.translationsKeys[langu_choos.value]['Title'],
            ...
            Padding(
              ...
              child: FlatButton(
                ...
                shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: MyTheme.light_grey, width: 1.0)),
                child: Text(
                  AppTranslation.translationsKeys[langu_choos.value]['SEND'],
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
  ...
  scaffold() {
    ...
    SnackBar _addedToCartSnackbar = SnackBar(
      content: Text(
        AppTranslation.translationsKeys[langu_choos.value]['Added to cart'],
        style: TextStyle(color: MyTheme.white),
      ),
      backgroundColor: MyTheme.accent_color,
      duration: const Duration(seconds: 7),
      action: SnackBarAction(
        label: AppTranslation.translationsKeys[langu_choos.value]['SHOW CART'],
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          child: CustomScrollView(
            ...
            slivers: <Widget>[
              ...
              SliverList(
                ...
                _productDetails != null
                    ? Column(
                        children: [buildChoiceOptionList(), buildAttFormList()],
                      )
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(AppTranslation.translationsKeys[langu_choos.value]['Seller'],
                  style: TextStyle(
      ...
      children: [
        Padding(
          ...
          child: Container(
            width: 75,
            child: Text(
              AppTranslation.translationsKeys[langu_choos.value]['Quantity'] +
                  ":",
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
        ...
        _productDetails.stock_visibility_state == 'hide'
            ? Container()
            : Padding(
  ...
  buildAttFormList() {
    return ListView.builder(
      itemCount: _productDetails.sttributesform.length,
      scrollDirection: Axis.vertical,
      shrinkWrap: true,
      physics: NeverScrollableScrollPhysics(),
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: buildAttForm(_productDetails.sttributesform, index),
        );
      },
    );
  }

  buildAttForm(sttributesform, att_form_index) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(
        16.0,
        8.0,
        ...
        children: [
          Padding(
            ...
            child: Container(
              //  width: 75,
              child: Text(
                sttributesform[att_form_index].title,
                style: TextStyle(color: Colors.red),
              ),
            ),
          ),
          ListView.builder(
            itemCount: sttributesform[att_form_index].attributelist.length,
            scrollDirection: Axis.vertical,
            physics: NeverScrollableScrollPhysics(),
            shrinkWrap: true,
            itemBuilder: (context, index) {
              // for(int i=0;i<_selectedattform.length;i++){
              _attformController.add(TextEditingController());
              //  }
              return Padding(
                padding: const EdgeInsets.only(bottom: 0.0),
                child: buildAttFormItem(
                    sttributesform[att_form_index].attributelist[index].title,
                    index,
                    index),
              );
            },
  ...
  buildAttFormItem(option, att_form_index, index) {
    // print('kkk');
    //print(att_form_index);
    return Padding(
      padding: const EdgeInsets.only(right: 8.0),
      child: Container(
        /*decoration: BoxDecoration(
            border: Border.all(
                color: _selectedattform[att_form_index] == option
                    ? MyTheme.accent_color
                    : Color.fromRGBO(224, 224, 225, 1),
                width: 1.5),
            borderRadius: BorderRadius.circular(3.0),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            width: MediaQuery.of(context).size.width - (75 + 40),
            child: TextField(
                controller: _attformController[att_form_index],
                autofocus: false,
                onChanged: (i) {
                  print(i);
                  print(att_form_index);
                  _onVariantChangeattform(att_form_index, i);
                },
                decoration: InputDecoration(
                    hintText: option,
                    hintStyle: TextStyle(fontSize: 15.0, color: MyTheme.golden),
                    enabledBorder: OutlineInputBorder(
                      borderSide:
      ...
      children: [
        Padding(
          ...
          child: Container(
            width: 75,
            child: Text(
              AppTranslation.translationsKeys[langu_choos.value]['Color'] + ":",
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
        ),
      ...
      children: [
        Padding(
          ...
          child: Container(
            width: 75,
            child: Text(
              AppTranslation.translationsKeys[langu_choos.value]['Club Point'] +
                  ":",
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
      ...
      children: [
        Padding(
          ...
          child: Container(
            width: 75,
            child: Text(
              AppTranslation.translationsKeys[langu_choos.value]['Price'] + ":",
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
        ),
        _productDetails.has_discount
            ? Column(
                children: [
                  ...
                  Text(
                    _singlePriceString + _taxmsg,
                    style: TextStyle(
                        color: _productDetails.has_discount
                            ? Colors.red
                            : MyTheme.accent_color,
                        fontSize: 18.0,
                        fontWeight: FontWeight.w600),
          ...
          child: Row(
            ...
            children: [
              ...
              FlatButton(
                ...
                child: Text(
                  AppTranslation.translationsKeys[langu_choos.value]['Buy Now'],
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.w600),
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: ListProductCard(
                  ...
                  tax_msg: _topProducts[index].tax_msg ?? ""),
            );
          },
        ),
      );
