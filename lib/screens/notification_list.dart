...
class _NotificationListState extends State<NotificationList> {
  ...
  fetchData() async {
    var notificationResponse = await NotificationRepository().getNotification(_page);
    _list.addAll(notificationResponse.notification_item_list);
    _isInitial = false;
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        AppTranslation.translationsKeys[langu_choos.value]['notifications'],
          ...
          Container(
            ...
            child: ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  image: AppConfig.BASE_PATH + _list[index].icon,
                  fit: BoxFit.contain,
                )),
          ),
          Container(
