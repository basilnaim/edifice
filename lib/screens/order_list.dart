...
class PaymentStatus {
  ...
  static List<PaymentStatus> getPaymentStatusList() {
    return <PaymentStatus>[
      PaymentStatus('', AppTranslation.translationsKeys[langu_choos.value]['All']),
      PaymentStatus('paid', AppTranslation.translationsKeys[langu_choos.value]['Paid']),
      PaymentStatus('unpaid', AppTranslation.translationsKeys[langu_choos.value]['Unpaid']),
    ];
  }
}
...
class DeliveryStatus {
  ...
  static List<DeliveryStatus> getDeliveryStatusList() {
    return <DeliveryStatus>[
      DeliveryStatus('', AppTranslation.translationsKeys[langu_choos.value]['All']),
      DeliveryStatus('confirmed', AppTranslation.translationsKeys[langu_choos.value]['Confirmed']),
      DeliveryStatus('on_delivery', AppTranslation.translationsKeys[langu_choos.value]['On Delivery']),
      DeliveryStatus('delivered', AppTranslation.translationsKeys[langu_choos.value]['Delivered']),
    ];
  }
}
