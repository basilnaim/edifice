...
class _AddressState extends State<Address> {
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              content: Padding(
                ...
                child: Text(
                  AppTranslation.translationsKeys[langu_choos.value]['Are you sure to remove this address'],
                  maxLines: 3,
              ...
              actions: [
                FlatButton(
                  child: Text(
                    AppTranslation.translationsKeys[langu_choos.value]['Cancel'],
                ...
                FlatButton(
                  ...
                  child: Text(
                    AppTranslation.translationsKeys[langu_choos.value]['Confirm'],
  ...
  onAddressAdd(context) async {
    ...
    if (address == "") {
      ToastComponent.showDialog(AppTranslation.translationsKeys[langu_choos.value]['Enter Address'], context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }

    if (_selected_city_name == "") {
      ToastComponent.showDialog(AppTranslation.translationsKeys[langu_choos.value]['Select a city'], context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }

    if (_selected_country_name == "") {
      ToastComponent.showDialog(AppTranslation.translationsKeys[langu_choos.value]['Select a country'], context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(AppTranslation.translationsKeys[langu_choos.value]['Address']+" *",
                    style: TextStyle(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        hintText: AppTranslation.translationsKeys[langu_choos.value]['Enter Address'],
                        hintStyle: TextStyle(
                            fontSize: 12.0,
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Text(AppTranslation.translationsKeys[langu_choos.value]['City']+" *",
                    style: TextStyle(
                        color: MyTheme.font_grey, fontSize: 12)),
              ),
              /*Padding(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: DropdownSearch<City>(
                    items: _cityList,
                    maxHeight: 300,
                    label: AppTranslation.translationsKeys[langu_choos.value]['Select a city'],
                    showSearchBox: true,
                    selectedItem: _selected_city,
                    dropdownSearchDecoration: InputDecoration(
                        hintText: AppTranslation.translationsKeys[langu_choos.value]['Enter City'],
                        hintStyle: TextStyle(
                            fontSize: 12.0,
                            color: MyTheme.textfield_grey),
                        enabledBorder: OutlineInputBorder(
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Text(AppTranslation.translationsKeys[langu_choos.value]['Postal Code'],
                    style: TextStyle(
                        color: MyTheme.font_grey, fontSize: 12)),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    autofocus: false,
                    decoration: InputDecoration(
                        hintText: AppTranslation.translationsKeys[langu_choos.value]['Enter Postal Code'],
                        hintStyle: TextStyle(
                            fontSize: 12.0,
                            color: MyTheme.textfield_grey),
                        enabledBorder: OutlineInputBorder(
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Text(AppTranslation.translationsKeys[langu_choos.value]['Country']+" *",
                    style: TextStyle(
                        color: MyTheme.font_grey, fontSize: 12)),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: DropdownSearch<Country>(
                    items: _countryList,
                    maxHeight: 300,
                    label: AppTranslation.translationsKeys[langu_choos.value]['Select a country'],
                    showSearchBox: true,
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Text(AppTranslation.translationsKeys[langu_choos.value]['phone'],
                    style: TextStyle(
                        color: MyTheme.font_grey, fontSize: 12)),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    autofocus: false,
                    decoration: InputDecoration(
                        hintText: AppTranslation.translationsKeys[langu_choos.value]['Enter Phone'],
                        hintStyle: TextStyle(
                            fontSize: 12.0,
                            color: MyTheme.textfield_grey),
                        enabledBorder: OutlineInputBorder(
              ...
              child: FlatButton(
                ...
                shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                        color: MyTheme.light_grey, width: 1.0)),
                child: Text(
                  AppTranslation.translationsKeys[langu_choos.value]['ADD'],
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      ...
                      child: FlatButton(
                        ...
                        shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                                color: MyTheme.light_grey, width: 1.0)),
                        child: Text(
                          AppTranslation.translationsKeys[langu_choos.value]['UPDATE'],
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                              fontWeight: FontWeight.w600),
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Column(
        children: [
          Text(
            AppTranslation.translationsKeys[langu_choos.value]['Addresses of user'],
            style: TextStyle(fontSize: 16, color: MyTheme.accent_color),
          ),
          Text(
            "* "+AppTranslation.translationsKeys[langu_choos.value]['Double tap on an address to make it default'],
  ...
  buildAddressList() {
    if (is_logged_in.value == false) {
      return Container(
          ...
          child: Center(
              child: Text(
                AppTranslation.translationsKeys[langu_choos.value]['Please log in to see the cart items'],
      ...
      return Container(
          ...
          child: Center(
              child: Text(
                AppTranslation.translationsKeys[langu_choos.value]['No Addresses is added'],
            style: TextStyle(color: MyTheme.font_grey),
          )));
    }
  }
      ...
      child: Card(
        ...
        child: Stack(
          children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 75,
                          child: Text(
                            AppTranslation.translationsKeys[langu_choos.value]['City'],
                            style: TextStyle(
                              color: MyTheme.grey_153,
                            ),
                          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 75,
                          child: Text(
                            AppTranslation.translationsKeys[langu_choos.value]['Postal Code'],
                            style: TextStyle(
                              color: MyTheme.grey_153,
                            ),
                          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 75,
                          child: Text(
                            AppTranslation.translationsKeys[langu_choos.value]['Country'],
                            style: TextStyle(
                              color: MyTheme.grey_153,
                            ),
                          ),
            ...
            Positioned(
                right: getxc.lang == 'ar'? 300:0,
                top: 0.0,
                child: InkWell(
                  onTap: () {
                    print(index);
                    print(_selected_city_list_for_update);
