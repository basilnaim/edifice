...
import '../screens/choosecontry.dart';
...
//  String lng;
  ...
  Future<void> _initPackageInfo() async {
    ...
    chooscountry = await prefs.get('chooscountry');
    langu_choos.value = await prefs.get('lng');
    getxc.changeLanguage(langu_choos.value);
    print('ggggg');
    print(chooscountry);
    print(langu_choos.value);
    setState(() {
      ...
      children: [
        Expanded(
            child: CustomSplashScreen(
              ...
              seconds: 5,
              //comment this
              navigateAfterSeconds: chooscountry == "1"
                ...
                builder: (_) => getxc.lang == 'ar'
                  ...
                  : Directionality(
                  textDirection: TextDirection.rtl, child: ChoosContry()),
        ...
        style: TextStyle(
          ...
          color: Colors.white,
              ...
              photoSize: (_screen_height/3)-20,
              //  backgroundPhotoSize: 500.0,
            )),
        Text(
          "V " + _packageInfo.version,
          style: TextStyle(
